...
<head>
    ...
    <title>Criar Conta - Columbia OS</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; }
        ...
        .btn-cancel { background-color: transparent; color: #e7e9ea; border: 1px solid #536471; border-radius: 9999px; padding: 15px; font-size: 1rem; font-weight: bold; cursor: pointer; transition: 0.2s; text-align: center; text-decoration: none; margin-top: 5px; }
...
<body>
    <div class="login-box">
        ...
        <form action="../actions/salvar_cadastro.php" method="POST" class="input-group">
            <input type="text" name="nome" class="input-twitter" placeholder="Nome de exibição" required autocomplete="off">
            <input type="text" name="username" class="input-twitter" placeholder="@nome_de_usuario" required autocomplete="off">
            <input type="password" name="password" class="input-twitter" placeholder="Senha" required>
            <button type="submit" class="btn-login">Inscrever-se</button>
            <a href="<?php echo BASE_URL; ?>/login.php" class="btn-cancel">Voltar</a>
        </form>
    </div>
</body>
</html>